...
<script type="text/javascript">
	function formValidation() {
		...
		if (money == "" || money.length == 0 || money == " ") {
			document.getElementById("Money").innerHTML = " please enter a valid deposit amount !";
			document.validForm.money.focus();
			return false;
		} else if (money <= 0) {
			document.getElementById("Money").innerHTML = "To deposit amount should be greater than 0 ";
			document.validForm.money.focus();
			return false;
		} else if (isNaN(money)) {
...
<body>
	<form method="get" action="/BankMiniProject/depositing"
    ...
    font-size:25px; margin: 0 auto;">
	 ...
	 <a href="/BankMiniProject/" style="margin-left: 190px;padding: 10px;" >Home</a> 
		...
		<div class="container"
			style="background-color: #FFA500; padding-top: 10px;width:1355px; ">
			<p
				style="background-color:; text-align: center; font-size: xx-large;">For Deposit</p>
