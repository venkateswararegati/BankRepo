    ...
    font-size:25px; margin: 0 auto;">
	 ...
	 <a href="/BankMiniProject/" style="margin-left: 190px;padding: 10px;" >Home</a> 
		...
		<div class="container"
			...
			<h1 style="color: blue; font-size: large;">Nothing to update
				because you are not entered any thing for update !</h1>
		</div>
		<h1
			style="color: blue; text-align: center; font-size: xx-large; bottom: 100px;">
			<a href="/BankMiniProject/userValidationPage">Edit Page</a>
		</h1>
	</form>
</body>
</html>