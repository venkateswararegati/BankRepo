...
<body>
	<form method="get" action="/BankMiniProject/findcredentialsforaccountinfo"
    ...
    font-size:25px; margin: 0 auto;">
	 ...
	 <a href="/BankMiniProject/" style="margin-left: 190px;padding: 10px;" >Home</a> 
		...
		<div class="container"
			...
			<p
				style="background-color:; text-align: center; font-size: xx-large;">Account info</p>
	...
	<!-- <div class="container" style="background-color: #FFA500;">
		<h1
			...
			<a href="/BankMiniProject/successpage">Back</a>
		</h1>
	</div> -->
</body>
</html>